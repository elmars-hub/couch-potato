...
export default function TvshowPage() {
  ...
  const SkeletonGrid = (
    <main className="min-h-screen bg-[#141414] py-8">
      <div className="container mx-auto px-4">
        <div className="h-9 w-64 bg-white/10 rounded mb-8 animate-pulse" />
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {Array.from({ length: 12 }).map((_, i) => (
            ...
            >
              <div className="relative w-full h-[300px] bg-white/10 animate-pulse" />
  ...
  return (
    <>
      {trending ? <TvCarousel tvshows={trending.results ?? []} /> : null}
